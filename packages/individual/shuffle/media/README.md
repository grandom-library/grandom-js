# @grandom/shuffle Media Assets

[![License: CC BY 4.0][url-cc-badge]][url-cc-license]

The [`media`][url-folder] folder contains the media assets of the [`shuffle`][url-package] package.
...
- Original Media Repository: [@grandom/shuffle][url-package]
...
[url-package]: https://github.com/grandom-library/grandom-js/tree/main/packages/shuffle
[url-folder]: https://github.com/grandom-library/grandom-js/tree/main/packages/shuffle/media
