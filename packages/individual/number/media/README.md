# @grandom/number Media Assets

[![License: CC BY 4.0][url-cc-badge]][url-cc-license]

The [`media`][url-folder] folder contains the media assets of the [`number`][url-package] package.
...
- Original Media Repository: [@grandom/number][url-package]
...
[url-package]: https://github.com/grandom-library/grandom-js/tree/main/packages/number
[url-folder]: https://github.com/grandom-library/grandom-js/tree/main/packages/number/media
