# @grandom/bigint Media Assets

[![License: CC BY 4.0][url-cc-badge]][url-cc-license]

The [`media`][url-folder] folder contains the media assets of the [`bigint`][url-package] package.
...
- Original Media Repository: [@grandom/bigint][url-package]
...
[url-package]: https://github.com/grandom-library/grandom-js/tree/main/packages/bigint
[url-folder]: https://github.com/grandom-library/grandom-js/tree/main/packages/bigint/media
