...
<p align="center">  
  <picture>
    <source media="(prefers-color-scheme: dark)" srcset="https://raw.githubusercontent.com/grandom-library/grandom-js/main/media/logo-bigint-dark.svg">
    <img alt="grandom-js bigint package logo" src="https://raw.githubusercontent.com/grandom-library/grandom-js/main/media/logo-bigint-light.svg" width="600">
  </picture>  
</p>
...
<p align="center">
  <!-- NPM badge -->
  <a href="https://www.npmjs.com/package/@grandom/bigint"><img src="https://img.shields.io/npm/v/@grandom/bigint?color=brightgreen&logo=npm" alt="release-badge"></a>
  <!-- CI badge -->
  ...
  <!-- Coverage badge -->
  <a href="https://app.codecov.io/gh/grandom-library/grandom-js/tree/main/packages"><img src="https://img.shields.io/codecov/c/github/grandom-library/grandom-js?flag=grandom-bigint&logo=codecov&logoColor=white" alt="coverage-badge"></a>
  <!-- Dependency badge -->
  ...
  <!-- Security badge -->
  <a href="https://socket.dev/npm/package/@grandom/bigint"><img src="https://img.shields.io/badge/Security-✔-brightgreen.svg?logo=auth0&logoColor=white" alt="release-workflow-badge"></a> 
</p>
