# @grandom/pick Media Assets

[![License: CC BY 4.0][url-cc-badge]][url-cc-license]

The [`media`][url-folder] folder contains the media assets of the [`pick`][url-package] package.
...
- Original Media Repository: [@grandom/pick][url-package]
...
[url-package]: https://github.com/grandom-library/grandom-js/tree/main/packages/pick
[url-folder]: https://github.com/grandom-library/grandom-js/tree/main/packages/pick/media
