# @grandom/core Media Assets

[![License: CC BY 4.0][url-cc-badge]][url-cc-license]

The [`media`][url-folder] folder contains the media assets of the [`core`][url-package] package.
...
- Original Media Repository: [@grandom/core][url-package]
...
[url-package]: https://github.com/grandom-library/grandom-js/tree/main/packages/core
[url-folder]: https://github.com/grandom-library/grandom-js/tree/main/packages/core/media
